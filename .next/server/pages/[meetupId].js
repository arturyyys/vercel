...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://Arturas:88888888@cluster0.j8ggi.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
    const db = client.db();
